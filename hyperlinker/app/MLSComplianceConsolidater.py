...
@app.route("/MLSComplianceConsolidater", methods=['GET', 'POST'])
def MLSComplianceConsolidater():
    ...
    if request.method == 'POST':
        ...
        #remove cases that don't need compliance review (not for MLS version)
...
#what the user-facing site looks like
    ...
    <link rel="stylesheet" href="/static/css/main.css"> 
    <h1>Summary of Compliance Reports for MLS</h1>
