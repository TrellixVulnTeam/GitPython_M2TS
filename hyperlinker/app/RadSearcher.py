...
def RadSearcher():
    ...
    if request.method == 'POST':
        ...
        RADBuildings = ["54-81 ALMEDA",
                        ...
                        "355 FORD",
                        "365 FORD, WING C",
                        "365 EAST 183RD, WING D",
                        "365 FORD",
                        "365 EAST 183RD, WING E",
                        "355 EAST 183RD",
                        "365 EAST 183RD, WING F",
                        "400 BROOK",
                        "404 BROOK",
                        "510 EAST 144TH",
                        "511 EAST 143RD",
        ...
        df = df[['Hyperlinked CaseID#','Primary Advocate','Street Address','Apt#/Suite#','City','Zip Code','Potential RAD Case?']]
...
#what the user-facing site looks like
    ...
    <h3>Instructions:</h3>
    <ul type="disc">
    <li>This tool is meant to be used in conjunction with the LegalServer report called <a href="https://lsnyc.legalserver.org/report/dynamic/?load=2372" target="_blank">Weekly Housing Intake Report</a>.</li>
