...
@app.route("/UAHPLPCleaner", methods=['GET', 'POST'])
def UAHPLPCleaner():
    if request.method == 'POST':
        ...
        #ERAP Testing, moved to housing toolbox
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    return '''
    <!doctype html>
    <title>UAHPLP Cleaner</title>
    <link rel="stylesheet" href="/static/css/main.css">  
    <h1>UAHPLP Cleanup Report:</h1>
