...
def ComplianceConsolidater():
    ...
    if request.method == 'POST':
        ...
        df = df[['Hyperlinked CaseID#','Assigned Branch/CC','Primary Advocate Name','No Legal Assistance Documented Tester','No Time Entered for 90 Days Tester','200% of Poverty Tester','125-200% of Poverty Tester','Funding Code 4000 Tester','No Age for Client Tester','Untimely Closed Tester','Untimely Closed Overridden Tester','Citizenship & Immigration Tester','Compliance Check Untimely Closed','Compliance Check Untimely Closed Overwritten','Compliance Check 125 to 200 Poverty Income Ineligible','Compliance Check 200 Poverty Income Eligible','Compliance Check Citizenship and Immigration','Attestation on File?','Staff Verified Non-Citizenship Documentation','Did any Staff Meet Client in Person?','Close Reason','Date Closed','CSR: Is Legal Assistance Documented?','Age in Days','Percentage of Poverty','LSC Eligible?','CSR Eligible','Income Eligible','Primary Funding Codes','Secondary Funding Codes','DOB Information','Group','CSR: Timely Closing?','Was Timely Closed overridden?','Tester Tester']]
        ...
        def save_xls(dict_df, path):
            ...
            for i in dict_df:
                ...
                worksheet.set_column('M:ZZ',0)
                worksheet.set_row(0,60)
                worksheet.write_comment('D1',
