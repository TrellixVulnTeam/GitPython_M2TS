...
def AllHousingSecondStep(): 
    if request.method == 'POST': 
        ...
        '''if request.form['SplitSpreadsheetsBy'] != "Agency":
            ...
            save_xls(ExcelSplit = request.form['SplitSpreadsheetsBy'], TabSplit = request.form['SplitCategory'], path = "app\\sheets\\zipped\\" + " " + f.filename[:-5] + ".xlsx")
            print(request.form['SplitSpreadsheetsBy'])
            print(request.form['SplitCategory'])
            ...
            return send_from_directory('sheets\\zipped', f.filename +'.zip', as_attachment = True)
        else:
            output_filename = f.filename
        
            save_xls(ExcelSplit = 'Agency', TabSplit = request.form['SplitCategory'], path = "app\\sheets\\" + output_filename)
        ...
        if request.form['SplitSpreadsheetsBy'] != "Agency":
            ...
            #output_filename = f.filename
            save_xls(ExcelSplit = 'Agency', TabSplit = request.form['SplitCategory'])
