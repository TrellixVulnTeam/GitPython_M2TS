...
#Reportable step 2, eliminates unreportable brief cases from cases that were clean/reportable
def ReportableTester2(Reportable,BriefElim):
    if BriefElim == 'Not Reportable' or BriefElim == 'Extra Case' or BriefElim == 'Additional Brief':
        return 'No'
    else:
        return Reportable
...
def Needs_Rollover(Open_Construct,Substantial_Activity, Substantial_Activity_Date,CaseID) :
    if int(Open_Construct) >= 20220701:
        ...
        return ''
    elif CaseID in ReportedFY19 or CaseID in ReportedFY21 or CaseID in ReportedFY20 or CaseID in ReportedFY22:
